...
placeholder="Please enter the class/grade" help="This is a required field" required validations="minLength:1"
          />
          <Input name="section" id="section" value="" label="Section" type="text"
placeholder="Please enter the section" validations="isAlphanumeric,minLength:1"
          />

...
export default class CreateQuestion extends Component {
  ...
  submitForm(){
    ...
    this.props.handleSubmit(myform.questionNo, myform.qnOrder, myform.qnText, myform.type, myform.grade, myform.minMarks, myform.maxMarks,2);
  }
        ...
        <div className="" role="document">
            <div className="modal-content">
                ...
                <div className="modal-body">
                    <Formsy.Form id="createQuestion" onValidSubmit={this.submitForm} onValid={this.enableSubmitButton} onInvalid={this.disableSubmitButton}
                disabled={this.state.disabled} ref={(ref) => this.myform = ref}>    
                     <Input name="questionNo" id="questionNo" value="" label="Question #" type="text"
                placeholder="Please enter the qn number" required validations="isNumeric"/>
                      <Input type="text" required label="Question Order" name="qnOrder" validations="isNumeric" placeholder="Please select the order you'd like the question at"/> 
                    <Textarea
                        rows={2}
                        cols={60}
                        name="qnText"
                    ...
                    <Row layout='horizontal'> 
                        <Input elementWrapperClassName="col-md-2" name="minMarks" label="Min Score" type="text" validations="isFloat" disabled={this.state.isGradeType}/>
                        <Input elementWrapperClassName="col-md-2" name="maxMarks" label="Max Score" type="text" validations="isFloat" disabled={this.state.isGradeType}/>                      
                    </Row>
                    </Formsy.Form>
                </div>

    ...
    return (
      <div id="registration-page">
              ...
              <form id="loginForm">
                <div className="form-group input-group">
                  ...
                  <input
                    ...
                    defaultValue="example@somewhere.com"
                  />
                </div>
                ...
                {this.props.error && <p> Registration Failed. Please try again.</p>}
              </form>
            </div>
          </div>
        </div>
        ...
        <div
          ...
          data-backdrop="false"
          id="regSuccessfulModal"
          tabIndex="-1"
          role="dialog"
          aria-labelledby="regSuccessfulModal"
        >
          <div className="modal-dialog" role="document">
            <div className="modal-content">
              ...
              <div className="modal-footer">
                <button type="button" className="btn btn-primary" onClick={this.goToLoginPage}>
                  OK
                </button>
              </div>
            </div>

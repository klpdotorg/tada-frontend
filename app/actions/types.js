...
export const SET_CREATE_BOUNDARY_ERROR = 'set_create_boundary_error';
...
export const GO_ANSWER_PAGINATION_BACK = 'go_answer_pagination_back';
export const GO_ANSWER_PAGINATION_NEXT = 'go_answer_pagination_next';
...
export const CHANGE_FP_MOBILE = 'change_fp_mobile';
export const CHANGE_FP_OTP = 'change_fp_otp';
export const CHANGE_FP_PASSWORD = 'change_fp_password';
export const FORGOT_PASSWORD_MOBILE_ERROR = 'forgot_password_mobile_error';
export const FORGOT_PASSWORD_OTP_ERROR = 'forgot_password_otp_error';
